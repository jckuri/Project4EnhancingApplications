...
prob_sampler = ProbabilitySampler(1.0)
tracer = Tracer(exporter = azure_exporter, sampler = prob_sampler)
...
azure_exporter = AzureExporter(connection_string = CONNECTION_STRING)
prob_sampler = ProbabilitySampler(1.0)
middleware = FlaskMiddleware(app, exporter = azure_exporter, sampler = prob_sampler)
